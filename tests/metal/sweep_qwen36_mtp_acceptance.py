...
SCHEMA = "qwen36-moe-mtp-acceptance-sweep-v1"
...
def render_markdown(report: dict[str, Any]) -> str:
    ...
    lines = [
        ...
        "",
        "| Prompt | Status | Drafted | Accepted | Acceptance | Emitted | Target steps/emitted | Wall s |",
        "|:---|:---|---:|---:|---:|---:|---:|---:|",
    ]
    for row in report["rows"]:
        ...
        lines.append(
            "| {prompt} | {status} | {drafted} | {accepted} | {rate} | {emitted} | {target} | {wall:.1f} |".format(
...
def main(argv: list[str]) -> int:
    ...
    summary = report["summary"]
    print(
        "[qwen36-mtp-acceptance-sweep] backend={} mode={} prompt_set={} measured={}/{} acceptance_rate={:.6f} target_steps_per_emitted={:.6f}".format(
            report["backend"],
            report["mode"],
            report["prompt_set"],
