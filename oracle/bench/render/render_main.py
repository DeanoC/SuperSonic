...
def main():
    ...
    render.add_argument("--out", required=True, type=Path,
                        help="Repo root containing docs/quality.md and docs/detailed_performance.md")
    render.add_argument("--perf-zone-key", default="bench-perf-matrix",
                        help="AUTOGEN zone key to update in docs/detailed_performance.md")
    ...
    if args.cmd == "markdown":
        ...
        perf_doc = (args.out / "docs" / "detailed_performance.md")
        if perf_doc.exists():
