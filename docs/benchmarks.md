...
Select the target device explicitly and leave enough free memory for the
artifact. The R9700 workflow records nonblocking throughput telemetry after
the correctness steps; telemetry failure must not hide a correctness result.
