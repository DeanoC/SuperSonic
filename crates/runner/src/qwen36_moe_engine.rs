...
use crate::qwen36_moe_vmm::{
    moe_island_cap_experts_from_env, moe_island_prefetch_ranks_from_env, should_try_moe_expert_vmm,
...
#[cfg(test)]
mod tests {
    use super::{ExpertRoute, MoeIslandPrefetchMode, MoeRouteTelemetry};
