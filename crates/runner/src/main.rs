...
use qwen35_trace::{
    ...
    trace_persistent_full_attn_layer, trace_persistent_linear_state_layer,
};
use qwen35_trace_utils::{bf16_residual_sum, bf16_round, sigmoid_fast};
...
use tensor_bytes::{bf16_bytes_to_f32 as decode_bf16_le, f32_bytes_to_f32 as decode_f32_le};
