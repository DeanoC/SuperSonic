...
const RANK3_SCALE_BF16_MINIMAL: [u8; 16] = [
    // e0/r0 = 1.0; e0 row padding = -4.0; e0/r1 = 0.5.
    0x80, 0x3f, 0x80, 0xc0, 0x00, 0x3f, // e0 expert padding = 3.0, -2.0; e1/r0 = 2.0.
    0x40, 0x40, 0x00, 0xc0, 0x00, 0x40, // e1 row padding = 1.5; e1/r1 = 0.25.
    0xc0, 0x3f, 0x80, 0x3e,
];

const RANK3_EXPECTED_BF16: [u8; 256] = [
    // e0/r0, scale 1.0
    0xe0, 0xc0, 0xc0, 0xc0, 0xa0, 0xc0, 0x80, 0xc0, 0x40, 0xc0, 0x00, 0xc0, 0x80, 0xbf, 0x00, 0x00,
    0x80, 0x3f, 0x00, 0x40, 0x40, 0x40, 0x80, 0x40, 0xa0, 0x40, 0xc0, 0x40, 0xe0, 0x40, 0x00, 0x00,
    0xe0, 0xc0, 0xc0, 0xc0, 0xa0, 0xc0, 0x80, 0xc0, 0x40, 0xc0, 0x00, 0xc0, 0x80, 0xbf, 0x00, 0x00,
    ...
    0x00, 0x3f, 0x80, 0x3f, 0xc0, 0x3f, 0x00, 0x40, 0x20, 0x40, 0x40, 0x40, 0x60, 0x40, 0x00, 0x00,
    0x60, 0xc0, 0x40, 0xc0, 0x20, 0xc0, 0x00, 0xc0, 0xc0, 0xbf, 0x80, 0xbf, 0x00, 0xbf, 0x00, 0x00,
    0x00, 0x3f, 0x80, 0x3f, 0xc0, 0x3f, 0x00, 0x40, 0x20, 0x40, 0x40, 0x40, 0x60, 0x40, 0x00, 0x00,
    // e1/r0, scale 2.0
    0x60, 0xc1, 0x40, 0xc1, 0x20, 0xc1, 0x00, 0xc1, 0xc0, 0xc0, 0x80, 0xc0, 0x00, 0xc0, 0x00, 0x00,
    0x00, 0x40, 0x80, 0x40, 0xc0, 0x40, 0x00, 0x41, 0x20, 0x41, 0x40, 0x41, 0x60, 0x41, 0x00, 0x00,
    0x60, 0xc1, 0x40, 0xc1, 0x20, 0xc1, 0x00, 0xc1, 0xc0, 0xc0, 0x80, 0xc0, 0x00, 0xc0, 0x00, 0x00,
    0x00, 0x40, 0x80, 0x40, 0xc0, 0x40, 0x00, 0x41, 0x20, 0x41, 0x40, 0x41, 0x60, 0x41, 0x00, 0x00,
    // e1/r1, scale 0.25
    0xe0, 0xbf, 0xc0, 0xbf, 0xa0, 0xbf, 0x80, 0xbf, 0x40, 0xbf, 0x00, 0xbf, 0x80, 0xbe, 0x00, 0x00,
    0x80, 0x3e, 0x00, 0x3f, 0x40, 0x3f, 0x80, 0x3f, 0xa0, 0x3f, 0xc0, 0x3f, 0xe0, 0x3f, 0x00, 0x00,
    0xe0, 0xbf, 0xc0, 0xbf, 0xa0, 0xbf, 0x80, 0xbf, 0x40, 0xbf, 0x00, 0xbf, 0x80, 0xbe, 0x00, 0x00,
    0x80, 0x3e, 0x00, 0x3f, 0x40, 0x3f, 0x80, 0x3f, 0xa0, 0x3f, 0xc0, 0x3f, 0xe0, 0x3f, 0x00, 0x00,
];
...
fn decodes_rank3_minimal_and_trailing_padded_planes_identically() {
    ...
    // Final expert padding: -1.0 and 4.0; carrier trailing: -0.25.
    scale_with_trailing.extend_from_slice(&[0x80, 0xbf, 0x80, 0x40, 0x80, 0xbe]);
    let trailing =
    ...
    assert_eq!(minimal, RANK3_EXPECTED_BF16);
    assert_eq!(&minimal[..TASK2_EXPECTED_BF16.len()], TASK2_EXPECTED_BF16);
    assert_eq!(trailing, RANK3_EXPECTED_BF16);
}
