...
mod tests {
    ...
    #[test]
    fn accepts_real_qwen36_dense_attention_projection_geometry_from_flm_descriptor() {
        let mut flm = flm_qwen36_dense_descriptor();
        flm.hidden_size = 5120;
        flm.num_attention_heads = 24;
        flm.head_dim = 256;
        ...
        assert_eq!(config.text_config.hidden_size, 5120);
        assert_eq!(config.text_config.num_attention_heads, 24);
