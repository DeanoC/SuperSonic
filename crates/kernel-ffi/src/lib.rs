...
pub use qwen35::{
    ...
    cuda_lm_head_argmax_bf16_f32accum, cuda_lm_head_bf16_gemm_4b, cuda_target_nll_bf16,
    matmul_rhs_transposed_4b, metal_argmax_bf16_into, metal_lm_head_argmax_bf16,
    metal_lm_head_argmax_bf16_into, metal_lm_head_argmax_bf16_with_partials_into,
    mtp_restore_linear_prefix, persistent_decode, persistent_decode_4b,
    persistent_decode_4b_qwen35_sm86_specialized,
